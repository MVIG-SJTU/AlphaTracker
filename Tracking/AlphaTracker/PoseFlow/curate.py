...
parser.add_argument(
    "--out_json", type=str, required=True, help="result json predicted by AlphaPose"
)
...
parser.add_argument(
    ...
    type=int,
    required=True,
    help="number of mice in the video. -1 for unknown.",
)
parser.add_argument(
    "--fill_blank_with_predict", type=bool, required=False, default=False, help=""
)
