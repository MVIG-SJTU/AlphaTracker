...
video_image_save_path = "/disk4/zexin/project/mice/datasets/imageFromVideo/%s/" % (
    image_folder_name
)
save_image_format = image_folder_name + "%d.png"
...
if cap.isOpened():
    ...
    success = False
    print(
        "read video failed!make sure that the video format is supported by cv2.VideoCapture"
    )
