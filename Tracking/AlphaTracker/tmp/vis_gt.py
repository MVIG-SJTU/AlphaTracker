...
## evalation setting
gt_json_file_train = (
    alphaPose_root + "/data/mice/" + exp_name + "_gt_forEval_train.json"
)
gt_json_file_valid = (
    alphaPose_root + "/data/mice/" + exp_name + "_gt_forEval_valid.json"
)
...
(
    ...
    num_allAnnot_train,
    num_allAnnot_valid,
) = data_utils.merge_clean_ln_split_Data(
    image_root_list,
    json_file_list,
    ln_image_dir,
    train_val_split,
...
data_utils.generate_h5(
    train_h5_file, train_data, num_allAnnot=num_allAnnot_train, num_pose=num_pose
)
data_utils.generate_h5(
    val_h5_file, valid_data, num_allAnnot=num_allAnnot_valid, num_pose=num_pose
)
