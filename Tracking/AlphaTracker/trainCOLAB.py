...
(
    ...
    num_allAnnot_train,
    num_allAnnot_valid,
) = data_utilsCOLAB.merge_clean_ln_split_Data(
    image_root_list,
    json_file_list,
    ln_image_dir,
    train_val_split,
...
data_utilsCOLAB.generate_h5(
    train_h5_file,
    train_data,
    num_allAnnot=num_allAnnot_train,
    num_pose=num_pose,
    num_mouse=num_mouse,
)
data_utilsCOLAB.generate_h5(
    val_h5_file,
    valid_data,
    num_allAnnot=num_allAnnot_valid,
    num_pose=num_pose,
    num_mouse=num_mouse,
)
...
data_utilsCOLAB.generate_yolo_data(
    list_file=train_list_file,
    data_in=train_data,  # image_root_in=ln_image_dir,\
...
data_utilsCOLAB.generate_yolo_data(
    ...
    data_in=valid_data,  # image_root_in=ln_image_dir,\
    image_root_in=image_root_list[0],
    yolo_annot_root=yolo_image_annot_root,
    image_suffix=image_suffix,
    color_img_prefix=color_img_prefix,
...
yolo_train_cmd = (
    "./darknet detector train cfg/mice.data cfg/yolov3-mice.cfg {} -gpus {}\n".format(
