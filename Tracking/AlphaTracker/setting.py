...
]  # list of image folder paths to the RGB images for training
json_file_list = [
...
train_val_split = (
    0.90  # ratio of data that used to train model, the rest will be used for validation
)
...
yolo_iter = (
    20000 + 20000 + 20000
)  ## if use pretrained model please make sure yolo_iter to be large enough to guarantee finetune is done
