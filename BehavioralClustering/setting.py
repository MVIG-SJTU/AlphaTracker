...
class args_class(object):
    def __init__(self):
        ...
        self.cluster_arg = [
            {
                ...
                "features_arg": [
                    ...
                    {
                        "feat_key": "contourPCA_fft_amp",
                        "weight": 1,
                        "norm": "zscore_all",
                    },
                    {
                        "feat_key": "contourPCA_fft_ang",
                        "weight": 1,
                        "norm": "zscore_all",
                    },
                    ...
                    {
                        "feat_key": "head_body_angles_TO",
                        "weight": 1,
                        "norm": "zscore_all",
                    },
                    {"feat_key": "displace_rho_TO", "weight": 1, "norm": "zscore_all"},
                    {
                        "feat_key": "displace_phi_c_TO",
                        "weight": 1,
                        "norm": "zscore_all",
                    },
                    {
                        "feat_key": "displace_phi_s_TO",
                        "weight": 1,
                        "norm": "zscore_all",
                    },
                    ...
                    {
                        "feat_key": "contourPCA_fft_amp_TO",
                        "weight": 1,
                        "norm": "zscore_all",
                    },
                    {
                        "feat_key": "contourPCA_fft_ang_TO",
                        "weight": 1,
                        "norm": "zscore_all",
                    },
                ],
        ...
        self.video_name_suffix = (
            "individual_behavior_single_80_testNewFeature_evalNewFeature"
        )
        ...
        assert (
            len(self.imgdir)
            == len(self.tracked_json)
            == len(self.contdir)
            == len(self.videodir)
        ), "The length of imgdir,tracked_json,contdir and videodir should be the same"
